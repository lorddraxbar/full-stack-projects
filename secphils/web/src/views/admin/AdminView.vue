...
const EMAIL_TEMPLATE_DEFAULTS = [
  ...
  },
  {
    ...
    subject: 'Your portal access for {{company}} was removed',
    kicker: 'SecPhils \u00b7 {{company}}',
    heading: 'Portal access removed',
    ...
    cta: '',
    footer: "You're receiving this because your SECPhils portal access was changed. Manage your notification preferences in the portal.",
    vars: ['{{name}}', '{{company}}'],
  },
  {
    name: 'teamMemberRemoved',
    title: 'Team member removed (rep confirmation)',
    hint: 'Available for the authorized representative who removed a teammate. The rep currently gets an in-app bell row only; this email template is used if the row is ever extended to email. Gated by the "Team Member Removed" notification preference.',
    subject: 'A team member\u2019s access was removed \u2014 {{company}}',
    kicker: 'SecPhils \u00b7 {{company}}',
    heading: 'Team member removed',
    body: '{{removedName}} ({{removedEmail}}) no longer has portal access to {{company}}. Their existing messages and documents remain part of your company\u2019s record.',
    cta: 'Open Team & Invitations',
    footer: "You're receiving this because you manage the {{company}} portal team.",
    vars: ['{{company}}', '{{removedName}}', '{{removedEmail}}'],
  },
  {
    name: 'repAssigned',
    ...
    subject: 'You\u2019re the authorized representative for {{company}}',
    kicker: 'SecPhils \u00b7 {{company}}',
    heading: 'You are now the authorized representative',
    ...
    footer: "You're receiving this because SECPhils designated you as the authorized representative for {{company}}. Manage your notification preferences in the portal.",
    vars: ['{{name}}', '{{company}}', '{{count}}', '{{countLabel}}'],
  },
  {
    name: 'repRemoved',
    title: 'No longer the authorized representative',
    hint: 'Sent to the PREVIOUS authorized representative when SECPhils moves the role to someone else, so the release is explicit. Paired with an in-app bell row; gated by the same "Authorized Rep Changed" preference.',
    subject: 'Authorized representative changed for {{company}}',
    kicker: 'SecPhils \u00b7 {{company}}',
    heading: 'No longer the authorized representative',
    ...
    cta: 'Open my projects',
    footer: "You're receiving this because SECPhils updated the authorized representative for {{company}}. Manage your notification preferences in the portal.",
    vars: ['{{name}}', '{{company}}', '{{newRep}}'],
  },
  {
    name: 'landing',
      ...
      <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div class="md:col-span-2">
            ...
            <p class="mt-1 text-xs text-gray-400">Shown in the About section of the marketing page. The section is hidden when left blank.</p>
          </div>
          <div class="md:col-span-2">
